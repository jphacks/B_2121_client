//
//  RestaurantOtherGroupCell.swift
//  goyotashi
//
...
final class RestaurantOtherGroupCell: UICollectionViewCell, View, ViewConstructor {
    ...
    // MARK: - Bind Method
    func bind(reactor: RestaurantOtherGroupCellReactor) {
        // Action
